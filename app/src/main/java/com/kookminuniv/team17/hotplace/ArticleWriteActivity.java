...
public class ArticleWriteActivity extends AppCompatActivity {
        ...
        switch(item.getItemId()){
            ...
            case R.id.completeBtn:
                ...
                // 제목과 내용이 있을 때,
                    ...
                    intent.putExtra("article_id", articles_number);
    ...
    public void saveContents(){
        ...
        String[] parsedAddress = "대한민국 서울특별시 성북구 정릉동 정릉로77".split(" ");  //+ 국민대
        ...
        dbRef.child(strAC).child("location_Latitude").setValue(37.610883);  //+ 위도
        dbRef.child(strAC).child("location_Longitude").setValue(126.995546);  //+ 경도
